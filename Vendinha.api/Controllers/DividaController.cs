...
namespace Vendinha.Controllers
{
    ...
    public class DividaController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public IActionResult Update(int id, [FromBody] Divida divida)
        {
            var sucesso = service.Atualizar(id, divida);
        ...
        public IActionResult Delete(int id)
        {
            ...
            return Ok("Dívida removida com sucesso.");
        }

        [HttpPut("{id}/pagar")]
        public IActionResult Pagar(int id)
        {
            var sucesso = service.MarcarPagamento(id);
